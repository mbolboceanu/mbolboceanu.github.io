...
## Papers
- [*A Toolkit for Succinct Lattice-Based Zero Knowledge Proofs*](https://eprint.iacr.org/2026/1289), with Beatrice Biasioli, [Vadim Lyubashevsky](https://research.ibm.com/people/vadim-lyubashevsky), [Antonio Merino-Gallardo](https://antonio.m-g.es/), [Michał Osadnik](https://www.osdnk.me/), Gregor Seiler and Patrick Steuer. In the proceedings of [CCS 2026](https://www.sigsac.org/ccs/CCS2026/index.html), to appear.
- [*Orthus: Practical Sublinear Batch-Verification of Lattice Relations from Standard Assumptions*](https://eprint.iacr.org/2026/398.pdf), with [Jonathan Bootle](https://jbootle.github.io/), [Vadim Lyubashevsky](https://research.ibm.com/people/vadim-lyubashevsky), [Antonio Merino-Gallardo](https://antonio.m-g.es/), and Gregor Seiler. In the proceedings of [Crypto 2026](https://crypto.iacr.org/2026/).
...
- [*Homomorphic Encryption: a Toy Implementation in Python*](https://bit-ml.github.io/blog/homomorphic-encryption-toy-implementation-in-python/)
- [*Private Set Intersection from Homomorphic Encryption: A Python Implementation*](https://bit-ml.github.io/blog/private-set-intersection-an-implementation-in-python/)
